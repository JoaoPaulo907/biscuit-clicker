...
Se você quiser testar o jogo e compartilhar seu feedback, arquivos executáveis para Windows, Linux e macOS estão disponíveis na página de Releases.

Apenas baixe a versão do seu sistema operacional e execute.

## Feedback

Não posso garantir que vou continuar a desenvolver esse projeto no futuro, mas se você encontrar um bug ou tiver qualquer sugestão de melhoria para o jogo, eu adoraria ouvir.
